...
var numb1:string | null =prompt("Enter the value of First number");
var numb2:string | null =prompt("Enter the value of Second number");
var numb3:number = Number(numb1);
var numb4:number = Number(numb2);
if(numb3>numb4){
...
var number1:string |null=prompt("Enter the value of first number");
var number2:string |null=prompt("Enter the value of Second number");
var number3:string |null=prompt("Enter the value of Third number");
var jawan1:number=Number(number1);
var jawan2:number=Number(number2);
var jawan3:number=Number(number3);
...
var bandaban:string | null = prompt("Apni marzi ka number likho or jadu dekho");
var bandabanyar:number = Number(bandaban);
if(bandabanyar<0){
...
var painumberday:string | null = prompt("Hanji number likh");
var paibandabanja:number = Number(painumberday);
...
var aikhornumb:string | null = prompt("Chal vai ch number day");
var chdanumb:number=Number(aikhornumb);
if(chdanumb%2==0){
...
var year:string | null = prompt("Chal vai year likh koi vi");
var year1:number = Number(year);
if(year1%4==0){
...
var hmm :string | null = prompt("Chal vi koi charcater likh dawo");
var hmm2:string  =String(hmm);
...
var umerbandaban:string | null = prompt("Write an alphabet ranging from A-Z");
var umerbhai:string = String(umerbandaban);
...
var aikcharcterpao:string | null = prompt("Write a charcter of your own choice");
var tabdeeli:any = aikcharcterpao;
...
var Character:string | null = prompt("Input any Charcter apni marzi da");
var tabdeeli2:string = String(Character);
...
var numberdaybhai:string | null = prompt("Input the week number or dekhna phir usi week kay din ayeingay(jadu)");
var jadustart:number = Number(numberdaybhai);
switch(jadustart){
    case 1:
        console.log("Week # 1");
        console.log("Day1");
...
var monthlikh:string | null = prompt("Input the month number of your own choice");
var monthtransform:number = Number(monthlikh);
...
var pehlaAngle :string | null = prompt("Write the first angle in degree of triangle");
var FirstAngle:number = Number(pehlaAngle);
var dosraAngle:string | null = prompt("Write the second angle in degree of the triangle");
var SecondAngle:number = Number(dosraAngle);
var tesraAngle:string | null = prompt("Write the third angle in degrees of the triangle");
var ThirdAngle:number = Number(tesraAngle);
...
var pehliSide:string | null = prompt("Input the first side of the Triangle");
var FirstSide:number = Number(pehliSide);
var dosriSide:string | null = prompt("Input the Second side of the Triangle");
var SecondSide:number = Number(dosriSide);
var tesriSide:string | null = prompt("Input the Third side of the Triangle");
var ThirdSide:number = Number(tesriSide);
...
var pehlaAngleday:string | null = prompt("Write the first angle of the triangle");
var FirstAngleday:number = Number(pehlaAngleday);
var dosraAngleday:string | null = prompt("Write the second angle of the triangle");
var SecondAngleday:number = Number(dosraAngleday);
var tesraAngleday:string | null = prompt("Write the third angle of the triangle");
var ThirdAngleday:number = Number(tesraAngleday);
...
var bolobuyprice:string | null = prompt("Write the buying price of your Goods");
var buyingprice:number = Number(bolobuyprice);
var bolosellprice:string | null = prompt("Write the selling price of your Goods");
var sellingprice:number = Number(bolosellprice);
...
var firstsubj:string | null = prompt("Write the marks of the Physics Subject");
var phynumber:number = Number(firstsubj);
var secondsubj:string | null = prompt("Write the marks of the Chemistry Subject");
var chemnumber:number = Number(secondsubj);
var thirdsubj:string | null = prompt("Write the marks of the Biology Subject");
var bionumber:number = Number(thirdsubj);
var fourthsubj:string | null = prompt("Write the marks of the Mathematics Subject");
var mathnumber:number = Number(fourthsubj);
var fifthsubj:string | null = prompt("Write the marks of the Computer Subject");
var compnumber:number = Number(fifthsubj);
var sum:number =phynumber+chemnumber+bionumber+mathnumber+compnumber;
...
var sallerybatao:string | null = prompt("Apni sallery das pai fer tenun bonus daiye");
var sallery:number=Number(sallerybatao);
if(sallery <= 10000 ){
